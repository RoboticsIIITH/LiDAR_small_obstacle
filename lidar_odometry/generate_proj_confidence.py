...
if __name__ == "__main__":
    ...
    root_path = "/media/ash/OS/IIIT_Labels/train/"
    sequences = os.listdir(root_path)

    # for seq_name in sequences:
    for seq_name in ["seq_2"]:
        ...
        odom_path = os.path.join(root_path,seq_name,"odometry")
        dest_path = os.path.join(root_path,seq_name,"context_proj_conf")
